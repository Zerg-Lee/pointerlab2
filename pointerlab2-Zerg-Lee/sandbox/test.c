...
static const size_t garbage_data = 0xdead5555bad5dead;
...
{
    rectangle_t rectangle = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data, (double)garbage_data};
...
{
    triangle_t triangle = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data};
...
{
    shape_t shape1;
    linked_list_node_t node1 = {&shape1, (linked_list_node_t*)garbage_data};
    linked_list_t list = {(compare_fn)garbage_data, (linked_list_node_t*)garbage_data};
...
static char* test_list_insert_single_unsorted_nonempty_start()
{
    ...
    linked_list_node_t node3 = {&shape3, (linked_list_node_t*)garbage_data};
...
static char* test_list_insert_multiple_unsorted()
{
    ...
    shape_t shape5;
    linked_list_node_t node1 = {&shape1, (linked_list_node_t*)garbage_data};
    linked_list_node_t node2 = {&shape2, (linked_list_node_t*)garbage_data};
    linked_list_node_t node3 = {&shape3, (linked_list_node_t*)garbage_data};
    linked_list_node_t node4 = {&shape4, (linked_list_node_t*)garbage_data};
    linked_list_node_t node5 = {&shape5, (linked_list_node_t*)garbage_data};
    linked_list_t list = {(compare_fn)garbage_data, (linked_list_node_t*)garbage_data};
    linked_list_init(&list, NULL);
    linked_list_insert(&list, &node1);
    mu_assert("Testing list insert empty list",
...
{
    linked_list_node_t node1 = {(shape_t*)1, (linked_list_node_t*)garbage_data};
    linked_list_node_t node2 = {(shape_t*)2, (linked_list_node_t*)garbage_data};
    linked_list_node_t node3 = {(shape_t*)3, (linked_list_node_t*)garbage_data};
    linked_list_node_t node4 = {(shape_t*)4, (linked_list_node_t*)garbage_data};
    linked_list_node_t node5 = {(shape_t*)5, (linked_list_node_t*)garbage_data};
    linked_list_t list = {(compare_fn)garbage_data, (linked_list_node_t*)garbage_data};
...
static char* test_list_insert_duplicate_sorted_by_shape_value()
{
    linked_list_node_t node1 = {(shape_t*)1, (linked_list_node_t*)garbage_data};
    linked_list_node_t node2 = {(shape_t*)2, (linked_list_node_t*)garbage_data};
    linked_list_node_t node3 = {(shape_t*)2, (linked_list_node_t*)garbage_data};
    linked_list_node_t node4 = {(shape_t*)4, (linked_list_node_t*)garbage_data};
    linked_list_node_t node5 = {(shape_t*)5, (linked_list_node_t*)garbage_data};
    linked_list_t list = {(compare_fn)garbage_data, (linked_list_node_t*)garbage_data};
    linked_list_init(&list, list_compare);
...
{
    rectangle_t rectangle1 = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data, (double)garbage_data};
    rectangle_t rectangle2 = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data, (double)garbage_data};
    triangle_t triangle3 = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data};
    rectangle_t rectangle4 = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data, (double)garbage_data};
    rectangle_t rectangle5 = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data, (double)garbage_data};
    ...
    linked_list_node_t node1 = {(shape_t*)&rectangle1, (linked_list_node_t*)garbage_data};
    linked_list_node_t node2 = {(shape_t*)&rectangle2, (linked_list_node_t*)garbage_data};
    linked_list_node_t node3 = {(shape_t*)&triangle3, (linked_list_node_t*)garbage_data};
    linked_list_node_t node4 = {(shape_t*)&rectangle4, (linked_list_node_t*)garbage_data};
    linked_list_node_t node5 = {(shape_t*)&rectangle5, (linked_list_node_t*)garbage_data};
    linked_list_t list = {(compare_fn)garbage_data, (linked_list_node_t*)garbage_data};
...
{
    rectangle_t rectangle1 = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data, (double)garbage_data};
    rectangle_t rectangle3 = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data, (double)garbage_data};
    triangle_t triangle3 = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data};
    rectangle_t rectangle4 = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data, (double)garbage_data};
    rectangle_t rectangle5 = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data, (double)garbage_data};
    rectangle_construct(&rectangle1, "rectangle1", 0.25, 0.25);
    ...
    rectangle_construct(&rectangle5, "rectangle5", 1, 1.5);
    linked_list_node_t node1 = {(shape_t*)&rectangle1, (linked_list_node_t*)garbage_data};
    linked_list_node_t node2 = {(shape_t*)&rectangle3, (linked_list_node_t*)garbage_data};
    linked_list_node_t node3 = {(shape_t*)&triangle3, (linked_list_node_t*)garbage_data};
    linked_list_node_t node4 = {(shape_t*)&rectangle4, (linked_list_node_t*)garbage_data};
    linked_list_node_t node5 = {(shape_t*)&rectangle5, (linked_list_node_t*)garbage_data};
    linked_list_t list = {(compare_fn)garbage_data, (linked_list_node_t*)garbage_data};
...
static char* tree_verify(tree_node_t* root, shape_t* min_shape, int num_nodes, bool cut)
{
    ...
    int node_count = 0;
    shape_t* prev = NULL;
    tree_iterator_t iter = {(tree_node_t*)garbage_data, (unsigned int)garbage_data, {(tree_node_t*)garbage_data}};
    for (int i = 0; i < MAX_DEPTH; i++) {
        iter.parents[i] = (tree_node_t*)garbage_data;
    }
...
static char* test_max_min_avg_area_balanced_tree()
{
    ...
    rectangle_t rectangle3 = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data, (double)garbage_data};
    rectangle_t rectangle4 = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data, (double)garbage_data};
    triangle_t triangle5 = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data};
    triangle_t triangle6 = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data};
    triangle_t triangle7  = {{{(area_fn)garbage_data, (perimeter_fn)garbage_data}, (const char*)garbage_data, (unsigned int)garbage_data}, (double)garbage_data};
    rectangle_construct(&rectangle1, "rectangle1", 3, 5);
